...
// notifyBothPartiesOfCancelation notifies the seller and the buyer that the trade has been canceled
func (e *ExchangeServer) notifyBothPartiesOfCancelation(co CompletedOrder) error {

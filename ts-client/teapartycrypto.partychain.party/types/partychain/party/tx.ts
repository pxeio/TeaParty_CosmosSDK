...
export interface MsgCreateOrdersAwaitingFinalizer {
  creator: string;
  index: string;
  nknAddress: string;
...
export interface MsgCreateOrdersAwaitingFinalizerResponse {
}

export interface MsgUpdateOrdersAwaitingFinalizer {
  creator: string;
  index: string;
  nknAddress: string;
  walletPrivateKey: string;
...
export interface MsgUpdateOrdersAwaitingFinalizerResponse {
}

export interface MsgDeleteOrdersAwaitingFinalizer {
  creator: string;
  index: string;
}

export interface MsgDeleteOrdersAwaitingFinalizerResponse {
}
...
function createBaseMsgCreateOrdersAwaitingFinalizer(): MsgCreateOrdersAwaitingFinalizer {
  return {
    creator: "",
    index: "",
    nknAddress: "",
...
export const MsgCreateOrdersAwaitingFinalizer = {
  encode(message: MsgCreateOrdersAwaitingFinalizer, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.creator !== "") {
      writer.uint32(10).string(message.creator);
    }
    if (message.index !== "") {
    ...
    if (message.nknAddress !== "") {
      writer.uint32(26).string(message.nknAddress);
    }
    if (message.walletPrivateKey !== "") {
      writer.uint32(34).string(message.walletPrivateKey);
    }
    if (message.walletPublicKey !== "") {
      writer.uint32(42).string(message.walletPublicKey);
    }
    if (message.shippingAddress !== "") {
      writer.uint32(50).string(message.shippingAddress);
    }
    if (message.refundAddress !== "") {
      writer.uint32(58).string(message.refundAddress);
    }
    if (message.amount !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): MsgCreateOrdersAwaitingFinalizer {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseMsgCreateOrdersAwaitingFinalizer();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): MsgCreateOrdersAwaitingFinalizer {
    return {
      creator: isSet(object.creator) ? String(object.creator) : "",
  ...
  toJSON(message: MsgCreateOrdersAwaitingFinalizer): unknown {
    const obj: any = {};
    message.creator !== undefined && (obj.creator = message.creator);
  ...
  fromPartial<I extends Exact<DeepPartial<MsgCreateOrdersAwaitingFinalizer>, I>>(
    object: I,
...
function createBaseMsgCreateOrdersAwaitingFinalizerResponse(): MsgCreateOrdersAwaitingFinalizerResponse {
  return {};
}

export const MsgCreateOrdersAwaitingFinalizerResponse = {
  encode(_: MsgCreateOrdersAwaitingFinalizerResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): MsgCreateOrdersAwaitingFinalizerResponse {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseMsgCreateOrdersAwaitingFinalizerResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        default:
  ...
  fromJSON(_: any): MsgCreateOrdersAwaitingFinalizerResponse {
    return {};
  },

  toJSON(_: MsgCreateOrdersAwaitingFinalizerResponse): unknown {
    const obj: any = {};
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<MsgCreateOrdersAwaitingFinalizerResponse>, I>>(
    _: I,
  ): MsgCreateOrdersAwaitingFinalizerResponse {
    const message = createBaseMsgCreateOrdersAwaitingFinalizerResponse();
    return message;
  },
};

function createBaseMsgUpdateOrdersAwaitingFinalizer(): MsgUpdateOrdersAwaitingFinalizer {
  return {
    creator: "",
    index: "",
    nknAddress: "",
...
export const MsgUpdateOrdersAwaitingFinalizer = {
  encode(message: MsgUpdateOrdersAwaitingFinalizer, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.creator !== "") {
      writer.uint32(10).string(message.creator);
    }
    if (message.index !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): MsgUpdateOrdersAwaitingFinalizer {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseMsgUpdateOrdersAwaitingFinalizer();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): MsgUpdateOrdersAwaitingFinalizer {
    return {
      creator: isSet(object.creator) ? String(object.creator) : "",
      index: isSet(object.index) ? String(object.index) : "",
      nknAddress: isSet(object.nknAddress) ? String(object.nknAddress) : "",
  ...
  toJSON(message: MsgUpdateOrdersAwaitingFinalizer): unknown {
    const obj: any = {};
    message.creator !== undefined && (obj.creator = message.creator);
    message.index !== undefined && (obj.index = message.index);
    message.nknAddress !== undefined && (obj.nknAddress = message.nknAddress);
  ...
  fromPartial<I extends Exact<DeepPartial<MsgUpdateOrdersAwaitingFinalizer>, I>>(
    object: I,
...
function createBaseMsgUpdateOrdersAwaitingFinalizerResponse(): MsgUpdateOrdersAwaitingFinalizerResponse {
  return {};
}

export const MsgUpdateOrdersAwaitingFinalizerResponse = {
  encode(_: MsgUpdateOrdersAwaitingFinalizerResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): MsgUpdateOrdersAwaitingFinalizerResponse {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseMsgUpdateOrdersAwaitingFinalizerResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        default:
  ...
  fromJSON(_: any): MsgUpdateOrdersAwaitingFinalizerResponse {
    return {};
  },

  toJSON(_: MsgUpdateOrdersAwaitingFinalizerResponse): unknown {
    const obj: any = {};
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<MsgUpdateOrdersAwaitingFinalizerResponse>, I>>(
    _: I,
  ): MsgUpdateOrdersAwaitingFinalizerResponse {
    const message = createBaseMsgUpdateOrdersAwaitingFinalizerResponse();
    return message;
  },
};

function createBaseMsgDeleteOrdersAwaitingFinalizer(): MsgDeleteOrdersAwaitingFinalizer {
  return { creator: "", index: "" };
}

export const MsgDeleteOrdersAwaitingFinalizer = {
  encode(message: MsgDeleteOrdersAwaitingFinalizer, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.creator !== "") {
      writer.uint32(10).string(message.creator);
    }
    if (message.index !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): MsgDeleteOrdersAwaitingFinalizer {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseMsgDeleteOrdersAwaitingFinalizer();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): MsgDeleteOrdersAwaitingFinalizer {
    return {
      creator: isSet(object.creator) ? String(object.creator) : "",
      index: isSet(object.index) ? String(object.index) : "",
    };
  ...
  toJSON(message: MsgDeleteOrdersAwaitingFinalizer): unknown {
    const obj: any = {};
    message.creator !== undefined && (obj.creator = message.creator);
    message.index !== undefined && (obj.index = message.index);
    return obj;
  ...
  fromPartial<I extends Exact<DeepPartial<MsgDeleteOrdersAwaitingFinalizer>, I>>(
    object: I,
...
function createBaseMsgDeleteOrdersAwaitingFinalizerResponse(): MsgDeleteOrdersAwaitingFinalizerResponse {
  return {};
}

export const MsgDeleteOrdersAwaitingFinalizerResponse = {
  encode(_: MsgDeleteOrdersAwaitingFinalizerResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): MsgDeleteOrdersAwaitingFinalizerResponse {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseMsgDeleteOrdersAwaitingFinalizerResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        default:
  ...
  fromJSON(_: any): MsgDeleteOrdersAwaitingFinalizerResponse {
    return {};
  },

  toJSON(_: MsgDeleteOrdersAwaitingFinalizerResponse): unknown {
    const obj: any = {};
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<MsgDeleteOrdersAwaitingFinalizerResponse>, I>>(
    _: I,
  ): MsgDeleteOrdersAwaitingFinalizerResponse {
    const message = createBaseMsgDeleteOrdersAwaitingFinalizerResponse();
    return message;
  },
};
...
export interface Msg {
  ...
  CreateOrdersAwaitingFinalizer(
    request: MsgCreateOrdersAwaitingFinalizer,
  ): Promise<MsgCreateOrdersAwaitingFinalizerResponse>;
  UpdateOrdersAwaitingFinalizer(
    request: MsgUpdateOrdersAwaitingFinalizer,
  ): Promise<MsgUpdateOrdersAwaitingFinalizerResponse>;
  /** this line is used by starport scaffolding # proto/tx/rpc */
  DeleteOrdersAwaitingFinalizer(
    request: MsgDeleteOrdersAwaitingFinalizer,
  ): Promise<MsgDeleteOrdersAwaitingFinalizerResponse>;
}
...
export class MsgClientImpl implements Msg {
  ...
  constructor(rpc: Rpc) {
    ...
    this.CreateOrdersAwaitingFinalizer = this.CreateOrdersAwaitingFinalizer.bind(this);
    this.UpdateOrdersAwaitingFinalizer = this.UpdateOrdersAwaitingFinalizer.bind(this);
    this.DeleteOrdersAwaitingFinalizer = this.DeleteOrdersAwaitingFinalizer.bind(this);
  }
  SubmitSell(request: MsgSubmitSell): Promise<MsgSubmitSellResponse> {
  ...
  CreateOrdersAwaitingFinalizer(
    ...
    const data = MsgCreateOrdersAwaitingFinalizer.encode(request).finish();
    const promise = this.rpc.request("teapartycrypto.partychain.party.Msg", "CreateOrdersAwaitingFinalizer", data);
    return promise.then((data) => MsgCreateOrdersAwaitingFinalizerResponse.decode(new _m0.Reader(data)));
  }

  UpdateOrdersAwaitingFinalizer(
    request: MsgUpdateOrdersAwaitingFinalizer,
  ): Promise<MsgUpdateOrdersAwaitingFinalizerResponse> {
    const data = MsgUpdateOrdersAwaitingFinalizer.encode(request).finish();
    const promise = this.rpc.request("teapartycrypto.partychain.party.Msg", "UpdateOrdersAwaitingFinalizer", data);
    return promise.then((data) => MsgUpdateOrdersAwaitingFinalizerResponse.decode(new _m0.Reader(data)));
  }

  DeleteOrdersAwaitingFinalizer(
    request: MsgDeleteOrdersAwaitingFinalizer,
  ): Promise<MsgDeleteOrdersAwaitingFinalizerResponse> {
    const data = MsgDeleteOrdersAwaitingFinalizer.encode(request).finish();
    const promise = this.rpc.request("teapartycrypto.partychain.party.Msg", "DeleteOrdersAwaitingFinalizer", data);
    return promise.then((data) => MsgDeleteOrdersAwaitingFinalizerResponse.decode(new _m0.Reader(data)));
  }
}

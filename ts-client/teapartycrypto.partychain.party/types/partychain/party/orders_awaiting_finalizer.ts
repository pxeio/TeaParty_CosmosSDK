...
export interface OrdersAwaitingFinalizer {
  index: string;
  nknAddress: string;
...
export const OrdersAwaitingFinalizer = {
  encode(message: OrdersAwaitingFinalizer, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.index !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): OrdersAwaitingFinalizer {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseOrdersAwaitingFinalizer();
  ...
  fromJSON(object: any): OrdersAwaitingFinalizer {
    return {
  ...
  toJSON(message: OrdersAwaitingFinalizer): unknown {
    const obj: any = {};
  ...
  fromPartial<I extends Exact<DeepPartial<OrdersAwaitingFinalizer>, I>>(object: I): OrdersAwaitingFinalizer {
    const message = createBaseOrdersAwaitingFinalizer();

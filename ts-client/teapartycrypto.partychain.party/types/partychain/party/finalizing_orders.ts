...
export interface FinalizingOrders {
  index: string;
...
function createBaseFinalizingOrders(): FinalizingOrders {
  return {
    index: "",
...
export const FinalizingOrders = {
  encode(message: FinalizingOrders, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.index !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): FinalizingOrders {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseFinalizingOrders();
  ...
  fromJSON(object: any): FinalizingOrders {
    return {
  ...
  toJSON(message: FinalizingOrders): unknown {
    const obj: any = {};
  ...
  fromPartial<I extends Exact<DeepPartial<FinalizingOrders>, I>>(object: I): FinalizingOrders {
    const message = createBaseFinalizingOrders();

...
import TeapartycryptoPartychainParty from './teapartycrypto.partychain.party'
...
export default { 
  TeapartycryptoPartychainParty: load(TeapartycryptoPartychainParty, 'teapartycrypto.partychain.party'),

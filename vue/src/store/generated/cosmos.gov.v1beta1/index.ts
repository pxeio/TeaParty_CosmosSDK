...
import { WeightedVoteOption } from "TeaPartyCrypto-partychain-client-ts/cosmos.gov.v1beta1/types"
import { TextProposal } from "TeaPartyCrypto-partychain-client-ts/cosmos.gov.v1beta1/types"
import { Deposit } from "TeaPartyCrypto-partychain-client-ts/cosmos.gov.v1beta1/types"
import { Proposal } from "TeaPartyCrypto-partychain-client-ts/cosmos.gov.v1beta1/types"
import { TallyResult } from "TeaPartyCrypto-partychain-client-ts/cosmos.gov.v1beta1/types"
import { Vote } from "TeaPartyCrypto-partychain-client-ts/cosmos.gov.v1beta1/types"
import { DepositParams } from "TeaPartyCrypto-partychain-client-ts/cosmos.gov.v1beta1/types"
import { VotingParams } from "TeaPartyCrypto-partychain-client-ts/cosmos.gov.v1beta1/types"
import { TallyParams } from "TeaPartyCrypto-partychain-client-ts/cosmos.gov.v1beta1/types"

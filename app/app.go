...
func New(
	...
	*/
	...
	app.PartyKeeper = *partymodulekeeper.NewKeeper(
		appCodec,
		keys[partymoduletypes.StoreKey],
		keys[partymoduletypes.MemStoreKey],
		app.GetSubspace(partymoduletypes.ModuleName),
	)
	partyModule := partymodule.NewAppModule(appCodec, app.PartyKeeper, app.AccountKeeper, app.BankKeeper)
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(partymoduletypes.ModuleName)

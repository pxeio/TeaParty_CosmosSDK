...
func (m *OrdersAwaitingFinalizer) GetCreator() string {
	if m != nil {
		return m.Creator
	}
	return ""
...
var fileDescriptor_dbc36992577845a8 = []byte{
	...
	,
}
...
func (m *OrdersAwaitingFinalizer) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Creator) > 0 {
		...
		i = encodeVarintOrdersAwaitingFinalizer(dAtA, i, uint64(len(m.Creator)))
		i--
		dAtA[i] = 0x42
	}
	if len(m.Amount) > 0 {

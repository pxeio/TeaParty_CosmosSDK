...
func NewMsgBuy(creator string, txID string, buyerShippingAddress string, buyerNKNAddress string, refundAddress string) *MsgBuy {
	return &MsgBuy{
		Creator:              creator,
		TxID:                 txID,
		BuyerShippingAddress: buyerShippingAddress,
		BuyerNKNAddress:      buyerNKNAddress,
